...
<head>
  ...
  <!-- favicon -->
  <!-- <link href="page/images/favicon.png" rel="shortcut icon"> -->

  <!-- 
  Essential stylesheets
  =====================================-->
  <link href="page/plugins/bootstrap/bootstrap.min.css" rel="stylesheet">
  <link href="page/plugins/bootstrap/bootstrap-slider.css" rel="stylesheet">
  <link href="page/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">
  <link href="page/plugins/slick/slick.css" rel="stylesheet">
  <link href="page/plugins/slick/slick-theme.css" rel="stylesheet">
  <link href="page/plugins/jquery-nice-select/css/nice-select.css" rel="stylesheet">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			...
			<a href="single.html">
				<img class="card-img-top img-fluid" src="page/images/products/products-1.jpg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="single.html">
				<img class="card-img-top img-fluid" src="page/images/products/products-2.jpg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			<!-- <div class="price">$200</div> -->
			<a href="single.html">
				<img class="card-img-top img-fluid" src="page/images/products/products-3.jpg" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
		    <h4 class="card-title"><a href="single.html">11inch Macbook Air</a></h4>
    ...
    <div class="row">
      <div class="col-lg-3 col-md-7 offset-md-1 offset-lg-0 mb-4 mb-lg-0">
        ...
        <div class="block about">
          <!-- footer logo -->
          <img src="page/images/logo-footer.png" alt="logo">
          <!-- description -->
      ...
      <div class="col-lg-4 col-md-7">
        ...
        <div class="block-2 app-promotion">
          <div class="mobile d-flex  align-items-center">
            <a href="index.html">
              <!-- Icon -->
              <img src="page/images/footer/phone-icon.png" alt="mobile-icon">
            </a>
            <p class="mb-0">Get the Dealsy Mobile App and Save more</p>
          </div>
          <div class="download-btn d-flex my-3">
            <a href="index.html"><img src="page/images/apps/google-play-store.png" class="img-fluid" alt=""></a>
            <a href="index.html" class=" ml-3"><img src="page/images/apps/apple-app-store.png" class="img-fluid" alt=""></a>
          </div>
        </div>
      </div>
    </div>
...
Essential Scripts
=====================================-->
<script src="page/plugins/jquery/jquery.min.js"></script>
<script src="page/plugins/bootstrap/popper.min.js"></script>
<script src="page/plugins/bootstrap/bootstrap.min.js"></script>
<script src="page/plugins/bootstrap/bootstrap-slider.js"></script>
<script src="page/plugins/tether/js/tether.min.js"></script>
<script src="page/plugins/raty/jquery.raty-fa.js"></script>
<script src="page/plugins/slick/slick.min.js"></script>
<script src="page/plugins/jquery-nice-select/js/jquery.nice-select.min.js"></script>
<!-- google map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU" defer></script>
<script src="page/plugins/google-map/map.js" defer></script>
