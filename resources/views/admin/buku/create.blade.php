...
<form method="POST" action="{{url('admin/buku/store')}}" encytype="multipart/form-data">
    @csrf
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text5" name="ket" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label for="text6" class="col-4 col-form-label">Foto</label> 
    <div class="col-8">
      <input id="text6" name="foto" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
