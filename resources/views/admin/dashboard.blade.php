...
<div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Chart Data Buku</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
...
// var myPieChart = new Chart(ctx, {
    var label = [@foreach($judulbuku as $item) '{{$item->judulbuku}}', @endforeach];
    var data = [@foreach($judulbuku as $item) {{$item->jumlah}}, @endforeach];
...
// var myLineChart = new Chart(ctx, {
    var lbl = [@foreach($hitung_anggota as $hitung) '{{$hitung->nama}}', @endforeach];
    var data = [@foreach($hitung_anggota as $hitung) {{$hitung->tgl_bergabung}}, @endforeach];
    document.addEventListener("DOMContentLoaded", () => {
